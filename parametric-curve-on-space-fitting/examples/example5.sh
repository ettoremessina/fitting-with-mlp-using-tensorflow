...
python ../pmc3t_fit.py --trainds datasets/example5_train.csv --modelout models/example5 \
...
python ../pmc3t_predict.py --model models/example5 --ds datasets/example5_test.csv --predictionout predictions/example5_pred.csv
