...
python ../pmc3t_fit.py --trainds datasets/example1_train.csv --modelout models/example1 \
...
python ../pmc3t_predict.py --model models/example1 --ds datasets/example1_test.csv --predictionout predictions/example1_pred.csv
