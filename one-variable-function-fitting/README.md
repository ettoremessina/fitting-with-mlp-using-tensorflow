...
It contains six python programs:
 ...
 - **fx_diag.py** generates a set of graphs to show the curves of loss function and the curves of metrics (if they are available both on training and validation datasets).
