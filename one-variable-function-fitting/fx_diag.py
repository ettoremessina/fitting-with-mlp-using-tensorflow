...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='fx_diag.py shows two overlapped x/y scatter graphs: the blue one is the dataset, the red one is the prediction')

    parser.add_argument('--dump',
                        type=str,
                        dest='dump_path',
                        required=True,
                        help='dump directory (generated by fx_fit)')

    parser.add_argument('--savefig_dir',
                        type=str,
