...
python ../pmc3t_fit.py --trainds datasets/example3_train.csv --modelout models/example3 \
...
python ../pmc3t_predict.py --model models/example3 --ds datasets/example3_test.csv --predictionout predictions/example3_pred.csv
