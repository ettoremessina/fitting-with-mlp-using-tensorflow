...
python ../pmc3t_fit.py --trainds datasets/example4_train.csv --modelout models/example4 \
...
python ../pmc3t_predict.py --model models/example4 --ds datasets/example4_test.csv --predictionout predictions/example4_pred.csv
