...
python ../pmc2t_fit_twin.py --trainds datasets/example5_twin_train.csv --modelout models/example5_twin \
...
python ../pmc2t_predict_twin.py --model models/example5_twin --testds datasets/example5_twin_test.csv --predicted predictions/example5_twin_pred.csv
