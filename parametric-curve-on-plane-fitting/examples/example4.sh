...
python ../pmc2t_predict.py --model models/example4 --ds datasets/example4_test.csv --predictionout predictions/example4_pred.csv

python ../pmc2t_plot.py --ds datasets/example4_test.csv --prediction predictions/example4_pred.csv
#python ../pmc2t_plot.py --ds datasets/example4_test.csv --prediction predictions/example4_test.csv --savefig predictions/example4.png
