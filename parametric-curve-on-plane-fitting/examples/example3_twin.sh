...
python ../pmc2t_fit_twin.py --trainds datasets/example3_twin_train.csv --modelout models/example3_twin \
...
python ../pmc2t_predict_twin.py --model models/example3_twin --ds datasets/example3_twin_test.csv --predictionout predictions/example3_twin_pred.csv

python ../pmc2t_plot.py --ds datasets/example3_twin_test.csv --prediction predictions/example3_twin_pred.csv
#python ../pmc2t_plot.py --ds datasets/example3_twin_test.csv --prediction predictions/example3_twin_pred.csv --savefig predictions/example3_twin.png
